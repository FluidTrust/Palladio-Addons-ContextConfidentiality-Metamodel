...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.confidentiality.context.model.ContextType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextTypeItemProvider extends EntityItemProvider {
    /**
    ...
    protected void addUniquePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ContextType_unique_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ContextType_unique_feature",
                                "_UI_ContextType_type"),
                        ModelPackage.Literals.CONTEXT_TYPE__UNIQUE, true, false, false,
    ...
    public String getText(Object object) {
        String label = ((ContextType) object).getEntityName();
        return label == null || label.length() == 0 ? getString("_UI_ContextType_type")
    ...
    public void notifyChanged(Notification notification) {
        ...
        case ModelPackage.CONTEXT_TYPE__UNIQUE:
