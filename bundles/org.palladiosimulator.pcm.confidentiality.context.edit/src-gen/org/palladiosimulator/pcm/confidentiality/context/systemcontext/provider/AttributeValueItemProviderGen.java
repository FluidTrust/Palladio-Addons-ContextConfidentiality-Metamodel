...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.confidentiality.context.systemcontext.AttributeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueItemProviderGen extends EntityItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public AttributeValueItemProviderGen(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SystemcontextPackage.Literals.ATTRIBUTE_VALUE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addValuesPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributeValue_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeValue_values_feature", "_UI_AttributeValue_type"),
				 SystemcontextPackage.Literals.ATTRIBUTE_VALUE__VALUES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
