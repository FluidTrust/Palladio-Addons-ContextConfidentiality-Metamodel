...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.confidentiality.context.systemcontext.Attributes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributesItemProvider 
		...
		IItemPropertySource
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(SystemcontextPackage.Literals.ATTRIBUTES__ATTRIBUTE);
		}
	...
	{
		return getString("_UI_Attributes_type");
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		{
			case SystemcontextPackage.ATTRIBUTES__ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemcontextPackage.Literals.ATTRIBUTES__ATTRIBUTE,
				 SystemcontextFactory.eINSTANCE.createSystemEntityAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(SystemcontextPackage.Literals.ATTRIBUTES__ATTRIBUTE,
				 SystemcontextFactory.eINSTANCE.createExternalSystemAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(SystemcontextPackage.Literals.ATTRIBUTES__ATTRIBUTE,
				 SystemcontextFactory.eINSTANCE.createSimpleAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(SystemcontextPackage.Literals.ATTRIBUTES__ATTRIBUTE,
				 SystemcontextFactory.eINSTANCE.createXMLAttribute()));
	}
