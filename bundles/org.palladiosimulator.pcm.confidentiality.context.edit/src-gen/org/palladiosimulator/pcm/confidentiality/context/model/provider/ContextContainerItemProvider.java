...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.confidentiality.context.model.ContextContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextContainerItemProvider extends EntityItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ModelPackage.Literals.CONTEXT_CONTAINER__CONTEXT);
        }
    ...
    public String getText(Object object) {
        String label = ((ContextContainer) object).getId();
        return label == null || label.length() == 0 ? getString("_UI_ContextContainer_type")
                : getString("_UI_ContextContainer_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        case ModelPackage.CONTEXT_CONTAINER__CONTEXT:
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ModelPackage.Literals.CONTEXT_CONTAINER__CONTEXT,
                ModelFactory.eINSTANCE.createHierarchicalContext()));

        newChildDescriptors.add(createChildParameter(ModelPackage.Literals.CONTEXT_CONTAINER__CONTEXT,
                ModelFactory.eINSTANCE.createSingleAttributeContext()));

        newChildDescriptors.add(createChildParameter(ModelPackage.Literals.CONTEXT_CONTAINER__CONTEXT,
                ModelFactory.eINSTANCE.createRelatedContextSet()));
    }
