...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.confidentiality.context.policy.Apply} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplyItemProvider extends ExpressionItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public ApplyItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Apply_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Apply_parameters_feature", "_UI_Apply_type"),
				 PolicyPackage.Literals.APPLY__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PolicyPackage.Literals.APPLY__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(PolicyPackage.Literals.APPLY__PARAMETERS);
		}
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Apply"));
	}
	...
	{
		String label = ((Apply)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Apply_type") :
			getString("_UI_Apply_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		{
			case PolicyPackage.APPLY__OPERATION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PolicyPackage.APPLY__PARAMETERS:
