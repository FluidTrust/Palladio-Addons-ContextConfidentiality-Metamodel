...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.confidentiality.context.specification.assembly.MethodSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodSpecificationItemProvider 
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MethodSpecification_connector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MethodSpecification_connector_feature", "_UI_MethodSpecification_type"),
				 AssemblyPackage.Literals.METHOD_SPECIFICATION__CONNECTOR,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AssemblyPackage.Literals.METHOD_SPECIFICATION__SIGNATURE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object)
	{
	    ...
	    if(object instanceof MethodSpecification) {
	        var methodSpecification = (MethodSpecification) object;
	        return methodSpecification.getConnector().getEntityName() + "->" + methodSpecification.getSignature().getEntityName();
	    }
