...
public class SystemAdapterFactory extends AdapterFactoryImpl
{
	...
	protected SystemSwitch<Adapter> modelSwitch =
		...
		{
			@Override
			public Adapter caseSystemSpecificationContainer(SystemSpecificationContainer object)
			{
				return createSystemSpecificationContainerAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseUsageSpecification(UsageSpecification object)
			{
				return createUsageSpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.system.SystemSpecificationContainer <em>Specification Container</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSystemSpecificationContainerAdapter()
	{
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.system.UsageSpecification <em>Usage Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
