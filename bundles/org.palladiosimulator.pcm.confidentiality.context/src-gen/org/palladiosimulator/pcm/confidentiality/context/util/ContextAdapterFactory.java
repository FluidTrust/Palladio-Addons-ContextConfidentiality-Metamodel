...
public class ContextAdapterFactory extends AdapterFactoryImpl
{
	...
	protected ContextSwitch<Adapter> modelSwitch =
		...
		{
			@Override
			public Adapter caseConfidentialAccessSpecification(ConfidentialAccessSpecification object)
			{
				return createConfidentialAccessSpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.ConfidentialAccessSpecification <em>Confidential Access Specification</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfidentialAccessSpecificationAdapter()
	{
		return null;
	}
