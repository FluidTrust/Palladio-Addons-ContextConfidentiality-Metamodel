...
public class SpecificationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected SpecificationSwitch<Adapter> modelSwitch = new SpecificationSwitch<Adapter>() {
        ...
        @Override
        public Adapter casePolicySpecification(PolicySpecification object) {
            return createPolicySpecificationAdapter();
        }

        @Override
        public Adapter casePCMSpecificationContainer(PCMSpecificationContainer object) {
            return createPCMSpecificationContainerAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.specification.ContextSpecification <em>Context Specification</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.specification.PolicySpecification <em>Policy Specification</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createPolicySpecificationAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.specification.PCMSpecificationContainer <em>PCM Specification Container</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createPCMSpecificationContainerAdapter() {
        return null;
    }
