...
public class UsageAdapterFactory extends AdapterFactoryImpl
{
	...
	protected UsageSwitch<Adapter> modelSwitch =
		...
		{
			@Override
			public Adapter casePCMUsageSpecification(PCMUsageSpecification object)
			{
				return createPCMUsageSpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.context.system.pcm.usage.PCMUsageSpecification <em>PCM Usage Specification</em>}'.
	 * <!-- begin-user-doc -->
