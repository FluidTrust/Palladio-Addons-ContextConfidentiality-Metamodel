 ...
 * <!-- end-user-doc -->
 * @see org.palladiosimulator.pcm.confidentiality.context.policy.PolicyPackage#getPolicyCombiningAlgorithm()
 * @model
 * @generated
 */
public enum PolicyCombiningAlgorithm implements Enumerator
{
	 ...
	 * @generated
	 */
	public static final List<PolicyCombiningAlgorithm> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
