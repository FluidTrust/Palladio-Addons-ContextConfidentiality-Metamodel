...
public final class AttackerEditPlugin extends EMFPlugin {
     ...
     * @generated
     */
    public static final AttackerEditPlugin INSTANCE = new AttackerEditPlugin();
    ...
    public AttackerEditPlugin() {
        super(new ResourceLocator[] { ContextEditPlugin.INSTANCE, IdentifierEditPlugin.INSTANCE,
