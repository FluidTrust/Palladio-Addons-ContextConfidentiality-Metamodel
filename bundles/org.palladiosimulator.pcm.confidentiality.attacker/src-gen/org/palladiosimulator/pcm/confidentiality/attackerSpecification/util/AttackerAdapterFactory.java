...
public class AttackerAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AttackerSwitch<Adapter> modelSwitch = new AttackerSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseVulnerabyContainer(VulnerabyContainer object) {
            return createVulnerabyContainerAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.attackerSpecification.VulnerabyContainer <em>Vulneraby Container</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
