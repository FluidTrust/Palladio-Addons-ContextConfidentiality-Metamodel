...
public class AttackSpecificationSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		...
		case AttackSpecificationPackage.VULNERABILITY: {
			...
			if (result == null)
				result = casePCMBaseClass(vulnerability);
			if (result == null)
				result = casePCMClass(vulnerability);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CATEGORY_ATTACK: {
			...
			if (result == null)
				result = caseAttack(categoryAttack);
			if (result == null)
				result = caseEntity(categoryAttack);
			if (result == null)
				result = caseIdentifier(categoryAttack);
			if (result == null)
				result = caseNamedElement(categoryAttack);
			if (result == null)
				result = casePCMBaseClass(categoryAttack);
			if (result == null)
				result = casePCMClass(categoryAttack);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CVE_VULNERABILITY: {
			...
			if (result == null)
				result = caseCWEBasedVulnerability(cveVulnerability);
			if (result == null)
				result = caseVulnerability(cveVulnerability);
			if (result == null)
				result = caseEntity(cveVulnerability);
			if (result == null)
				result = caseIdentifier(cveVulnerability);
			if (result == null)
				result = caseNamedElement(cveVulnerability);
			if (result == null)
				result = casePCMBaseClass(cveVulnerability);
			if (result == null)
				result = casePCMClass(cveVulnerability);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CWEID: {
			...
			if (result == null)
				result = caseAttackCategory(cweid);
			if (result == null)
				result = caseNamedElement(cweid);
			if (result == null)
				result = casePCMBaseClass(cweid);
			if (result == null)
				result = casePCMClass(cweid);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.ATTACK_CATEGORY: {
			...
			if (result == null)
				result = caseNamedElement(attackCategory);
			if (result == null)
				result = casePCMBaseClass(attackCategory);
			if (result == null)
				result = casePCMClass(attackCategory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CWE_ATTACK: {
			...
			if (result == null)
				result = caseCategoryAttack(cweAttack);
			if (result == null)
				result = caseAttack(cweAttack);
			if (result == null)
				result = caseEntity(cweAttack);
			if (result == null)
				result = caseIdentifier(cweAttack);
			if (result == null)
				result = caseNamedElement(cweAttack);
			if (result == null)
				result = casePCMBaseClass(cweAttack);
			if (result == null)
				result = casePCMClass(cweAttack);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CVE_ATTACK: {
			...
			if (result == null)
				result = caseCategoryAttack(cveAttack);
			if (result == null)
				result = caseAttack(cveAttack);
			if (result == null)
				result = caseEntity(cveAttack);
			if (result == null)
				result = caseIdentifier(cveAttack);
			if (result == null)
				result = caseNamedElement(cveAttack);
			if (result == null)
				result = casePCMBaseClass(cveAttack);
			if (result == null)
				result = casePCMClass(cveAttack);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CVEID: {
			...
			if (result == null)
				result = caseAttackCategory(cveid);
			if (result == null)
				result = caseNamedElement(cveid);
			if (result == null)
				result = casePCMBaseClass(cveid);
			if (result == null)
				result = casePCMClass(cveid);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AttackSpecificationPackage.CWE_VULNERABILITY: {
			...
			if (result == null)
				result = caseVulnerability(cweVulnerability);
			if (result == null)
				result = caseCWEBasedVulnerability(cweVulnerability);
			if (result == null)
				result = caseEntity(cweVulnerability);
			if (result == null)
				result = caseIdentifier(cweVulnerability);
			if (result == null)
				result = caseNamedElement(cweVulnerability);
			if (result == null)
				result = casePCMBaseClass(cweVulnerability);
			if (result == null)
				result = casePCMClass(cweVulnerability);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case AttackSpecificationPackage.ROLE: {
			...
			if (result == null)
				result = casePCMBaseClass(role);
			if (result == null)
				result = casePCMClass(role);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
