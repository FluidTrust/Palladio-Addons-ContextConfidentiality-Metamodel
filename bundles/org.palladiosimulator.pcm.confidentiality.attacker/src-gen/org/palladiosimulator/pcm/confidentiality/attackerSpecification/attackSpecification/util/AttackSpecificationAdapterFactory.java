...
public class AttackSpecificationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AttackSpecificationSwitch<Adapter> modelSwitch = new AttackSpecificationSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseCredentialAttack(CredentialAttack object) {
            return createCredentialAttackAdapter();
        }

        @Override
        public Adapter caseCredentialVulnerability(CredentialVulnerability object) {
            return createCredentialVulnerabilityAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.attackerSpecification.attackSpecification.CredentialAttack <em>Credential Attack</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createCredentialAttackAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.confidentiality.attackerSpecification.attackSpecification.CredentialVulnerability <em>Credential Vulnerability</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createCredentialVulnerabilityAdapter() {
        return null;
    }
